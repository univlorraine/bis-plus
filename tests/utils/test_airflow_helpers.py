# tests/utils/test_airflow_helpers.py
"""
...
class TestAirflowVariableManagerGet:
    ...
    @patch('amue.utils.airflow_helpers.AirflowVariableManager.get')
    ...
    def test_get_with_sdk_available(self):
        ...
        with patch.dict('sys.modules', {'airflow.sdk': MagicMock()}):
            ...
            with patch('amue.utils.airflow_helpers.AirflowVariableManager.get') as mock_get:
...
class TestAirflowVariableManagerSetIntegration:
    ...
    @patch('amue.utils.airflow_helpers.logger')
