...
class TestBlueGreenState:
    ...
    def test_default_state(self):
        ...
        from common.application.bluegreen.bluegreen_manager import BlueGreenState
...
class TestBlueGreenManagerMarkers:
    ...
    @patch('common.application.bluegreen.bluegreen_lock_manager.AdminStateManager')
    @patch('common.application.bluegreen.bluegreen_state_manager.AdminStateManager')
    def test_mark_import_started(self, mock_admin_cls, mock_admin_lock_cls):
        """Marque le début de l'import"""
        from common.application.bluegreen.bluegreen_manager import BlueGreenManager, BlueGreenState
        mock_admin = MagicMock()
        mock_admin_cls.return_value = mock_admin
        mock_admin_lock_cls.return_value = mock_admin
    ...
    @patch('common.application.bluegreen.bluegreen_lock_manager.AdminStateManager')
    @patch('common.application.bluegreen.bluegreen_state_manager.AdminStateManager')
    def test_mark_import_completed(self, mock_admin_cls, mock_admin_lock_cls):
    ...
    @patch('common.application.bluegreen.bluegreen_lock_manager.AdminStateManager')
    @patch('common.application.bluegreen.bluegreen_state_manager.AdminStateManager')
    def test_mark_import_completed_with_explicit_target(self, mock_admin_cls, mock_admin_lock_cls):
    ...
    @patch('common.application.bluegreen.bluegreen_lock_manager.AdminStateManager')
    @patch('common.application.bluegreen.bluegreen_state_manager.AdminStateManager')
    def test_mark_import_completed_without_target_reads_views(self, mock_admin_cls, mock_admin_lock_cls):
