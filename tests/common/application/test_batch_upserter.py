"""Tests unitaires pour BatchUpserter."""
import pytest
...
class TestGetQualifiedTableName:
    ...
    def test_table_name_lowercased(self):
        ...
        inserter = BatchUpserter(target_schema="splus_green")
...
class TestExecuteBatch:
    ...
    @patch('common.application.batch_upserter.execute_values')
