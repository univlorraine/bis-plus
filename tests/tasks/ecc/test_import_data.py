...
class TestECCDataImporter:
    ...
    @patch('ecc.operators.pipeline.ecc_data_importer.create_postgres_hook')
    ...
    @patch('ecc.operators.pipeline.ecc_data_importer.BatchInserter')
    @patch('ecc.operators.pipeline.ecc_data_importer.ECCSourceHook')
    @patch('ecc.operators.pipeline.ecc_data_importer.create_postgres_hook')
