...
class TestTableFilterFilterTables:
    ...
    def test_filter_tables_missing_raises_error(self, mock_varmgr):
        ...
        from amue.operators.table_filter import AMUETableFilter, TableNotFoundError
...
class TestTableNotFoundError:
    ...
    def test_exception_message(self):
        ...
        from amue.operators.table_filter import TableNotFoundError
