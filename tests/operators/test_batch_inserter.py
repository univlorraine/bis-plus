# tests/operators/test_batch_inserter.py
"""
...
class TestExecuteBatch:
    ...
    def test_batch_insert_no_commit(self):
    ...
    def test_raises_database_error_on_connection_issue(self):
        """Test erreur de connexion DB."""
        mock_cursor = Mock()
        mock_cursor.executemany.side_effect = OperationalError("Connection lost")
        mock_conn = Mock()
    ...
    def test_raises_database_error_on_interface_error(self):
        """Test erreur d'interface DB."""
        mock_cursor = Mock()
        mock_cursor.executemany.side_effect = InterfaceError("Interface error")
        mock_conn = Mock()
