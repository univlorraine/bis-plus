...
class TestTableFilterInit:
    ...
    @patch('amue.application.table_management.table_filter.NotificationService', None)
...
class TestTableFilterFilterTables:
    ...
    def test_filter_tables_missing_raises_error(self):
        ...
        from amue.application.table_management.table_filter import AMUETableFilter, TableNotFoundError
...
class TestTableNotFoundError:
    ...
    def test_exception_message(self):
        ...
        from amue.application.table_management.table_filter import TableNotFoundError
