...
class TestTableManagerInit:
    ...
    @patch('amue.application.table_management.table_manager.resolve_postgres_hook')
...
class TestTableManagerValidation:
    ...
    def test_validate_structure_info_missing_fields(self, mock_create_hook):
        ...
        from amue.domain.exceptions import AMUESchemaError
...
class TestTableManagementResult:
    ...
    def test_result_dataclass(self):
        ...
        from amue.application.table_management.table_manager import TableManagementResult
