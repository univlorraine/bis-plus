...
class TestPollingServiceConfig:
    ...
    @patch('amue.application.polling_service.VarMgr')
    def test_load_default_config(self, mock_varmgr):
        ...
        from amue.application.polling_service import AMUEPollingService, PollingConfig
...
class TestPollingServiceWaitForReady:
    ...
    @patch('amue.application.polling_service.VarMgr')
    @patch('amue.application.polling_service.time.sleep')
...
class TestPollingResult:
    ...
    def test_polling_result_success(self):
        ...
        from amue.application.polling_service import PollingResult
