...
def _run_orchestrator(table_info, verifier_result, manage_result=None):
    ...
    with patch('amue.application.table_setup_orchestrator.AMUETableVerifier') as MockVerifier, \
         patch('amue.application.table_setup_orchestrator.AMUETableManager') as MockManager:
