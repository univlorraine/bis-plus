...
class TestStatusMonitorWatch:
    ...
    def _run_n_iterations(self, checker, n_iterations=1):
        ...
        with patch('amue.application.status_monitor.datetime') as mock_dt, \
             patch('amue.application.status_monitor.time') as mock_time:
    ...
    def test_first_response_is_always_logged(self):
        ...
        with patch('amue.application.status_monitor.logger') as mock_logger:
