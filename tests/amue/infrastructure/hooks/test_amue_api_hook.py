...
class TestAMUEAPIHookTokenExpiration:
    ...
    @patch('amue.infrastructure.hooks.amue_api_hook.get_airflow_connection')
    ...
    def test_is_token_expired_token_still_valid(self, mock_get_conn):
        ...
        from amue.infrastructure.hooks.amue_api_hook import AMUEAPIHook, _token_cache
    ...
    def test_is_token_expired_token_expired(self, mock_get_conn):
        ...
        with patch('amue.infrastructure.hooks.amue_api_hook.datetime') as mock_dt:
    ...
    @patch('amue.infrastructure.hooks.amue_api_hook.get_airflow_connection')
    @patch('amue.infrastructure.hooks.amue_api_hook.requests.post')
