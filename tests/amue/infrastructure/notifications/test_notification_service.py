...
class TestEmailConfig:
    ...
    def test_email_config_defaults(self):
        ...
        from common.infrastructure.notifications.email_service import EmailConfig
    ...
    @patch('common.infrastructure.config.airflow_helpers.AirflowVariableManager')
...
class TestEmail:
    ...
    def test_email_creation(self):
        """Creation d'un email"""
        from common.infrastructure.notifications.email_service import Email
...
class TestEmailService:
    ...
    def test_init_default_config(self, mock_varmgr):
        ...
        from common.infrastructure.notifications.email_service import EmailService
    ...
    def test_init_custom_config(self):
        ...
        from common.infrastructure.notifications.email_service import EmailService, EmailConfig
    ...
    @patch('common.infrastructure.notifications.email_service.smtplib.SMTP')
    @patch('common.infrastructure.config.airflow_helpers.AirflowVariableManager')
    def test_send_success(self, mock_varmgr, mock_smtp):
        ...
        from common.infrastructure.notifications.email_service import EmailService, Email
...
class TestNotificationService:
    ...
    @patch('amue.infrastructure.notifications.notifier.VarMgr')
    @patch('common.infrastructure.config.airflow_helpers.AirflowVariableManager')
...
class TestNotificationTemplates:
    ...
    def test_escape_html(self):
        """Echappement HTML"""
        from amue.infrastructure.notifications.templates import NotificationTemplates
