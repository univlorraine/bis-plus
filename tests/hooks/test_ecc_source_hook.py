...
class TestGetDriver:
    ...
    def test_returns_oracledb_when_available(self):
        from ecc.hooks.ecc_source_hook import _get_driver
...
class TestGetConnOracle:
    ...
    def test_connects_with_correct_credentials(self):
        ...
        with patch('ecc.hooks.ecc_source_hook._get_driver', return_value=oracle), \
...
class TestGetConnMSSQL:
    ...
    def test_connects_with_dsn_string(self):
        ...
        with patch('ecc.hooks.ecc_source_hook._get_driver', return_value=pyodbc), \
             patch('ecc.hooks.ecc_source_hook.get_airflow_connection', return_value=airflow_conn):
            hook.get_conn()
