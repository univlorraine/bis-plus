...
CREATE VIEW splus.v_z_udl_get_auth_values_cf AS
    ...
    agr_1251.field,
    ust12.von
   FROM {target_schema}.agr_users agr_users
     LEFT JOIN {target_schema}.agr_1251 agr_1251 ON agr_1251.agr_name = agr_users.agr_name AND agr_1251.object = 'F_FICA_CTR'::bpchar AND agr_1251.field = 'FM_FICTR'::bpchar
     LEFT JOIN {target_schema}.ust12 ust12 ON ust12.objct = agr_1251.object AND agr_1251.auth = ust12.auth AND agr_1251.field = ust12.field
  WHERE agr_users.agr_name ~~ 'YP%'::text;
