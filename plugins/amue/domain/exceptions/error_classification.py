...
Classification des exceptions AMUE (retryable ou non, catégorie pour les métriques)."""
from amue.domain.exceptions.base import AMUEError
from amue.domain.exceptions.api import AMUEAPIError, AMUENetworkError
from amue.domain.exceptions.import_ import AMUEDatabaseError
from amue.domain.exceptions.bluegreen import ConcurrentImportError
...
def get_error_category(error: Exception) -> str:
    ...
    """
    from amue.domain.exceptions.api import AMUEAuthError, AMUENetworkError, AMUEAPIError
    from amue.domain.exceptions.import_ import AMUEDatabaseError, AMUEBatchError, AMUEImportError
    from amue.domain.exceptions.schema import AMUESchemaError
    from amue.domain.exceptions.bluegreen import AMUEBlueGreenError
