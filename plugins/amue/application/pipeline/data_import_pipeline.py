...
from amue.domain.exceptions import AMUEDatabaseError, AMUEBatchError, AMUEDataError
...
class DataImportPipeline:
    ...
    def __init__(self, streamer, inserter: BatchUpserter, target_schema: str = None):
        """
        Args:
            streamer: AMUEDataStreamer pour la lecture depuis l'API
            inserter: BatchUpserter pour l'insertion PostgreSQL
    ...
    def run(
        ...
        num_workers: int = 1,
        correlation_id: str = "",
        worker_inserters: List[BatchUpserter] = None,
        ...
        if worker_inserters is not None:
            ...
            for _ in range(num_workers):
                ...
                worker_inserters.append(BatchUpserter(worker_hook, target_schema=self.target_schema))
        else:
            own_workers = False
