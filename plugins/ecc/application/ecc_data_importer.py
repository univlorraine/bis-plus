...
from common.infrastructure.database.schema_introspection import table_exists
...
class ECCDataImporter:
    ...
    def import_table(
        ...
        inserter = BatchUpserter(postgres_hook=self.pg_hook, target_schema=self.target_schema)
    ...
    def _ensure_table_exists(
        ...
        if table_exists(self.pg_hook, self.target_schema, table_name):
            return
        ...
        col_defs.extend(build_meta_column_defs(self.source))
